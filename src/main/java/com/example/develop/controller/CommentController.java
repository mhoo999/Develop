...
import com.example.develop.dto.request.RetrieveCommentRequestDto;
...
public class CommentController {
    ...
    @GetMapping
    public ResponseEntity<List<CommentResponseDto>> getAll(@Validated @RequestBody RetrieveCommentRequestDto requestDto) {
        List<CommentResponseDto> ResponseDtoList = commentService.getAll(requestDto.getUserId(), requestDto.getScheduleId());
